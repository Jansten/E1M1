# PUP - General Guidelines and Requirements


## Overview

These are the general, overall guidelines for PUP (and all related shows).  For more detailed information, please see the additional files in this directory.
...
* Audio needs to be delivered to the editor in with the following requirements:
	...
	* All audio files need to be delivered to the "PUP Podcast" Dropbox, unless explicitely stated by the editor.
